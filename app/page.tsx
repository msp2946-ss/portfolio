        ...
        <section id="about" className="section">
          <div className="container-xxl">
            <SectionTitle
              title="About"
              accent="Me"
              subtitle="Passionate computer science student with a drive for innovation and problem-solving."
              center
            />
              ...
              <div className="grid gap-6">
                <div className="card">
                  ...
                  <p className="text-xs text-subtext mt-1">
                    2024–2028 — Greater Noida
                  </p>
                  <p className="text-subtext mt-2 text-sm">
                    Related Coursework: DSA, OOPs, Developments, AI
                  </p>
                </div>
                <div className="card">
        ...
        <section id="experience" className="section">
          <div className="container-xxl">
            <SectionTitle
              title="My"
              accent="Experience"
              subtitle="A journey through hands-on projects, competitions, and learning experiences"
              center
            />
        ...
        <section id="projects" className="section">
          <div className="container-xxl">
            <SectionTitle
              title="Featured"
              accent="Projects"
              subtitle="A showcase of my technical skills through real-world applications"
              center
            />
            <div className="grid gap-8">
              {projects.map((p) => (
